...
const MAP: Record<string, { label: string; Comp: () => React.ReactNode }> = {
  "particle-field": { label: "Particle Field", Comp: ParticleField },
  "aurora-mesh": { label: "Aurora Mesh", Comp: AuroraMesh },
  "spotlight-grid": { label: "Spotlight Grid", Comp: SpotlightGrid },
};
